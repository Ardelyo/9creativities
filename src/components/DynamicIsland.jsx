...
const DynamicIsland = () => {
  ...
  const navItems = [
    ...
    { title: "Generator Presentasi", icon: <Presentation className="w-5 h-5 sm:w-6 sm:h-6" />, path: "/presentation-generator" },
  ];

  const islandVariants = {
    collapsed: { width: '180px', height: '36px', borderRadius: '18px' },
    expanded: { width: '280px', height: '260px', borderRadius: '24px' },
  };
