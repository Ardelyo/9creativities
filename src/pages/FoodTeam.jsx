...
import { ArrowLeft, Utensils, FileText, Camera } from 'lucide-react';
...
import FoodProjectCard from '../components/FoodProjectCard';
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-gray-800 flex items-center">
              <Utensils className="mr-2" /> Kenalan dengan Tim Kami
            </h2>
            <FoodTeamMembers />
          </motion.div>
          ...
          <div className="grid grid-cols-1 gap-12">
            {projects.map((project) => (
              <FoodProjectCard key={project.id} project={project} />
            ))}
          </div>
        </div>
      </div>
