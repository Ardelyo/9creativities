...
const About = () => {
  ...
  return (
    <DropletAnimation>
      <div className="min-h-screen bg-gray-900 p-6 sm:p-12 relative overflow-hidden flex items-center justify-center">
        <BackgroundArt />
        <div className="max-w-8xl w-full mx-auto relative z-10">
          <Link to="/" className="text-blue-400 hover:text-blue-300 transition-colors mb-12 inline-block text-2xl">
            <ArrowLeft className="mr-2 inline w-8 h-8" /> Back
          </Link>
          <motion.div
          ...
          <motion.div 
            ...
            animate="visible"
            whileHover="hover"
            className="mb-24 p-16 bg-gray-800 rounded-3xl shadow-xl"
          >
            <h2 className="text-5xl font-bold mb-10 text-blue-400 flex items-center">
              <Users className="mr-6 w-12 h-12" /> Our Team
            </h2>
            <p className="text-gray-300 mb-16 text-2xl leading-relaxed">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-16">
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="w-48 h-48 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full mx-auto mb-8 flex items-center justify-center shadow-lg">
                    <img src={member.image} alt={member.name} className="w-44 h-44 rounded-full object-cover" />
                  </div>
                  <p className="font-semibold text-white text-3xl mb-3">{member.name}</p>
                  <p className="text-blue-400 text-xl">{member.role}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-5xl font-bold mb-10 text-blue-400 flex items-center">
              <Lightbulb className="mr-6 w-12 h-12" /> Our Mission
            </h2>
          ...
          >
            <h2 className="text-5xl font-bold mb-10 text-blue-400 flex items-center">
              <Award className="mr-6 w-12 h-12" /> Our Vision
            </h2>
            <p className="text-gray-300 text-2xl leading-relaxed">
