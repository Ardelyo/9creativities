  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-teal-700 p-4 relative overflow-hidden">
      <svg className="absolute top-0 left-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 100">
        <path d="M0,0 C30,20 70,20 100,0 L100,100 L0,100 Z" fill="rgba(255,255,255,0.1)" />
        <path d="M0,20 C30,40 70,40 100,20 L100,100 L0,100 Z" fill="rgba(255,255,255,0.05)" />
      </svg>
      <BackgroundArt />
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="h-1 bg-gradient-to-r from-emerald-300 via-teal-400 to-green-500 mx-auto mb-4"
          />
        </motion.div>
