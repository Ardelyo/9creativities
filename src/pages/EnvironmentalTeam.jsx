    ...
    <DropletAnimation>
      <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-blue-600">
          ...
          <motion.div
            ...
            className="mb-16 bg-white rounded-3xl p-8 md:p-10 shadow-xl"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">Pengenalan Teknologi Lingkungan</h2>
            ...
            <motion.h3 
              className="text-2xl md:text-3xl font-semibold mb-4 text-green-600"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                ...
                >
                  <img src={member.image} alt={member.name} className="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto mb-4 object-cover" />
                  <h3 className="text-2xl font-semibold text-gray-800">{member.name}</h3>
                  <p className="text-green-600 mb-2 text-lg">{member.role}</p>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-gray-800 flex items-center">
          ...
          <div className="grid grid-cols-1 gap-16">
            {projects.map((project) => (
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800 flex items-center">
                  ...
                  <p className="text-gray-600 text-xl">{project.documentation}</p>
                </div>
              </motion.div>
            ))}
          </div>
