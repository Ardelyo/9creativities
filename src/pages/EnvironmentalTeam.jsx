    ...
    <DropletAnimation>
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-teal-700 p-4 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-[40px] shadow-lg overflow-hidden">
            <div className="p-8">
              ...
              <motion.div
                ...
                className="mb-12 bg-emerald-800 bg-opacity-50 rounded-[30px] p-8 shadow-lg transform hover:scale-105 transition-all duration-300"
              >
              ...
              <motion.div
                ...
                className="mb-12 bg-emerald-800 bg-opacity-50 rounded-[30px] p-8 shadow-lg"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {teamMembers.map((member, index) => (
                    <motion.div
                      key={index}
                      className="bg-emerald-700 bg-opacity-50 p-6 rounded-[20px] text-center shadow-lg transform hover:rotate-3 transition-all duration-300"
              ...
              <div className="grid grid-cols-1 gap-12">
                {projects.map((project) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5 }}
                    className="bg-emerald-800 bg-opacity-50 rounded-[30px] overflow-hidden shadow-lg transform hover:scale-105 transition-all duration-300"
                  >
