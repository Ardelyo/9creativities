...
import { handleSendMessage } from '../utils/robotCUtils';

const RobotC = () => {
  const [apiKey, setApiKey] = useState('');
  const [message, setMessage] = useState('');
  const [chat, setChat] = useState([
    { role: 'assistant', content: "👋 Halo! Saya Robot C, asisten AI untuk Nine Creativities. Apa yang ingin kamu ketahui tentang proyek-proyek keren kami? 🚀" }
  ]);
  ...
  return (
    <motion.div 
      className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 p-4 sm:p-8 relative overflow-hidden"
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-4 text-blue-600">
            Chat dengan <span className="text-purple-600">Robot C</span>
          </h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-500 to-purple-500">
          ...
          <div className="p-4 sm:p-6 bg-gray-50 border-t border-gray-200">
            <div className="flex items-center space-x-2">
              ...
              <Button 
                ...
                className="rounded-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 transition-colors duration-300"
              >
